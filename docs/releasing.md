...
The build script (and `.distignore`) excludes:
- `premium/` — entire folder
...
Free and premium share the same version number. Keep them in sync on every release.
